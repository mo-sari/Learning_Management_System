...
import {
  ...
  useFetchStudentCourseList,
} from "../base/CustomHooks";
import { userId } from "../../utils/constants";

function Dashboard() {
  const { studentSummary } = useFetchStudentSummary(userId);
  const { studentCourseList } = useFetchStudentCourseList(userId);
